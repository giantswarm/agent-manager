"""ATS smoke for the agent-manager chart.
...
# fallback is app-tests-deploy-namespace in .ats/main.yaml. ATS names the release
# after the chart, so the chart's fullname is the bare chart name.
